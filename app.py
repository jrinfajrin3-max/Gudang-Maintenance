...
# ==========================================
# 1. KONFIGURASI HALAMAN & CSS (LENGKAP)
# ==========================================
st.set_page_config(
...
# ==========================================
# 4. LOGIKA UTAMA (ROUTER PAGE & SEARCH)
# ==========================================
...
# ROUTER HALAMAN
    ...
    df_delay = df[df['Jadwal Jatuh Tempo'] <= current_date_wib]
    ...
    with st.form("form_update"):
        ...
        # Dropdown kombinasi
        options = (df['Nama Mesin'] + " | " + df['Nama Part']).tolist()
        ...
        if st.form_submit_button("Konfirmasi Update"):
            # Cari baris data
            idx = df[df['Nama Mesin'] + " | " + df['Nama Part'] == selected_part].index[0]
...
# ==========================================
# 5. LOGIKA JAM REAL-TIME WIB (Update per Detik)
# ==========================================
